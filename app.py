...
<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="flex justify-center border-b border-gray-700 mb-10">
        <button onclick="switchTab(1)" id="tab1" class="tab px-10 py-4 tab-active text-xl">1번 폴더</button>
        <button onclick="switchTab(2)" id="tab2" class="tab px-10 py-4 text-xl">2번 폴더</button>
    </div>
